...
public class AddWaypointButtonScript : MonoBehaviour {
     ...
     * 
     * Since this script is attached to AddWaypointButton,
     * we'll want to send a message to Master to let it know
     * that AddWaypointButton was touched.
     * 
     **/
    private void tappedHandler(object sender, EventArgs e)
	{
		...
		state.SendMessage ("ChangeAddState", hit);
